...
class PapyrusInheritance:
    """
    Provides methods for handling Papyrus script inheritance.
    """
    ...
    def get_chain(papyrus:PapyrusContext, project:PapyrusProject, script:Script) -> list[Script]:
        ...
        if not parent_name:
            ...
            if script_name != "ScriptObject":
                ...
                try:
                    script_object = PapyrusInheritance.find_extends(papyrus, project, script, "ScriptObject")
        ...
        current_script:Script = PapyrusInheritance.find_extends(papyrus, project, script, parent_name)
        ...
        while current_script:
            ...
            next_script:Script = PapyrusInheritance.find_extends(papyrus, project, script, next_parent_name)
